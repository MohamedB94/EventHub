...
export default function Register() {
  ...
  const validate = () => {
    ...
    if (!form.prenom.trim()) errs.prenom = "Le prénom est obligatoire";
      ...
      errs.prenom = "Minimum 2 caractères";
    ...
    if (!form.mot_de_passe)
      errs.mot_de_passe = "Le mot de passe est obligatoire";
  ...
  return (
    <div className='auth-wrapper auth-login auth-register'>
      <div className='auth-left'>
        ...
        <div className='auth-tagline'>
          ...
          <p>
            Des milliers d'événements vous attendent. Créez votre compte et
            participez.
          </p>
        </div>
        ...
        <div className='auth-card'>
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className='field-row'>
              ...
              <div
                className={`field-group ${errors.prenom ? "has-error" : ""}`}
              >
                <label>Prénom</label>
                <div className='input-wrapper'>
                  <span className='input-icon'>👤</span>
          ...
          <p className='auth-switch auth-switch-register'>
